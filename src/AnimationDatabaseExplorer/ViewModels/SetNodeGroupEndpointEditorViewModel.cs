...
namespace AnimationDatabaseExplorer.ViewModels
{
    ...
    public class GroupEndpointEditorViewModel<T> : ValueEditorViewModel<T>, IGroupEndpointEditorViewModel
    {
        ...
        {
            Locator.CurrentMutable.Register(() => new GroupEndpointEditorView(),
                typeof(IViewFor<GroupEndpointEditorViewModel<T>>));
        }

        public GroupEndpointEditorViewModel(SetNodeGroupIOBinding nodeGroupBinding)
        {
